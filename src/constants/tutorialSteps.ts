...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    message: 'Страховка куплена! Если смартфон сломается, ты заплатишь только 20% от ущерба (это называется франшиза — твоя часть оплаты). Без страховки пришлось бы платить 100%. Важно: страховка одноразовая — после использования нужно купить заново.',
    autoAdvanceMs: 6000,
  },
  {
    id: 'trigger_incident',
  ...
  },
  {
    ...
    message: 'Инцидент! Видишь разницу? Со страховкой ты платишь только 20% от ущерба. Нажми «Страховая выплата», чтобы воспользоваться страховкой.',
