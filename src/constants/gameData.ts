...
export const SHOP_ITEMS = [
  ...
  { id: 'car', locationId: 'house', name: 'Автомобиль', cost: 8000, insuranceCost: 800, income: 500, riskChance: 0.12, isoCoords: { x: 200, y: 500 } }
];
...
export const INCIDENTS = [
  ...
  { id: 'car_crash', title: 'ДТП', damage: 4000, insurable: true, requiredItemId: 'car' }
];
...
export const LOCATION_UPGRADES = [
  ...
  { id: 'house_car',   locationId: 'house',     name: 'Автомобиль (декор)', cost: 8000,  image: '/decor_car.png',    scale: 0.18, depth: 1, flipX: true,  isoCoords: { x: 200, y: 520 } },
